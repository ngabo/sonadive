...
(function () {
  ...
  const PAGE_MAPS = {
    ...
    home: {
      ...
      '.service-card:nth-child(1) h3': ['EPM', 'EPM'],
      '.service-card:nth-child(1) p':  ['Forecasting, budgeting, and scenario planning.', 'Prévisions, budgétisation et planification de scénarios.'],
      '.service-card:nth-child(2) h3': ['Data Analytics', 'Analytique de données'],
      '.service-card:nth-child(2) p':  ['Transform raw data into actionable insights.', 'Transformez vos données brutes en insights actionnables.'],
      '.service-card:nth-child(3) h3': ['Business Intelligence', "Intelligence d'affaires"],
      '.service-card:nth-child(3) p':  ['Interactive dashboards and KPI reporting.', 'Tableaux de bord interactifs et reporting KPI.'],
      ...
      '.tech-stack .section-eyebrow': ['TECHNOLOGY WE USE', 'TECHNOLOGIES UTILISÉES'],
      '.tech-stack h2': ['Tools We Work With', 'Outils Que Nous Utilisons'],
    ...
    about: {
      ...
      '.page-hero p:not(.page-hero-eyebrow)': ['Sonadive was built on one belief: every business decision should be powered by data. We partner with organisations to unlock the full potential of their data assets.',
